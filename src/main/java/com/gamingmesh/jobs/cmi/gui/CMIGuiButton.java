...
public class CMIGuiButton {
	...
	b.setCommandMap(new HashMap<GUIManager.GUIClickType, List<GUIButtonCommand>>(commandMap));
	return b;
    }
    ...
    public CMIGuiButton addCommand(String command, GUIManager.CommandType vis) {
	return addCommand(null, command, vis);
    }

    public CMIGuiButton addCommand(GUIManager.GUIClickType type, String command) {
	return addCommand(type, command, GUIManager.CommandType.gui);
    }

    public CMIGuiButton addCommand(GUIManager.GUIClickType type, String command, GUIManager.CommandType vis) {
	if (type == null) {
