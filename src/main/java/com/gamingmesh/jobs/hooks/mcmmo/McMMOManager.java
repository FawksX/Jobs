...
public class McMMOManager {
	...
	if (McMMO != null) {
		...
		if (!mcMMOPresent)
		    Jobs.logger().info(" &6mcMMO was found - &cBut your McMMO version is outdated, please update for full support.");

		// Still enabling event listener for repair
		return true;
	    }

	    Jobs.logger().info(" &6mcMMO" + McMMO.getDescription().getVersion() + " was found - Enabling capabilities.");
	    return true;
	}
